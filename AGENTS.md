...
| `-cmp <sample.h5> <reference.h5> <output type> <output dir> [<config.json>]` | Compare two workspaces: compute average spectrum from each, emit ratio/difference. Output types: `Comparator ratio`, `Comparator difference` |
